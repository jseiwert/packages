...
def create_import_diagram(output_format, filename):
    ...
    dot.attr(rankdir='LR', fontsize='16', fontname='Arial')  # Safe default font
    dot.attr(size='10,7')
...
if __name__ == '__main__':
    ...
    create_import_diagram('png', 'python_imports_diagram')
    create_import_diagram('pdf', 'python_imports_diagram')

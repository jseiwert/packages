...
if __name__ == '__main__':
    ...
    create_import_diagram('png', '2025-03-21-CGPT-4o-R16-PythonImportsGraphviz_Helvetica')
    create_import_diagram('pdf', '2025-03-21-CGPT-4o-R16-PythonImportsGraphviz_Helvetica')
